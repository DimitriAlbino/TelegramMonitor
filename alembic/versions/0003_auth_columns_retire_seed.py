...
The demo user has a known password (``demo12345``) so the stack stays demoable
...
# password: demo12345 — argon2 hash generated by the app's hash_password().
# (login: demo@example.com / demo12345). Change in any real deploy.
DEMO_PASSWORD_HASH = (
